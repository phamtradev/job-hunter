...
public class SecurityUtil {
    ...
    @Value("${phamtra.jwt.access-token-validity-in-seconds}") // thời gian hết hạn
    ...
    public String createRefeshToken(String email, ResLoginDTO dto) {
        Instant now = Instant.now();
        Instant validity = now.plus(this.refreshTokenExpiration, ChronoUnit.SECONDS); //tính thời gian hết hạn
